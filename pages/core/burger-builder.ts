...
import { BurgerDataService } from "./burger_data_service";
...
export class BurgerBuilder implements IBuilder {
  ...
  setStep(name: BurgerSteps) {
    this.recipe.push(BurgerDataService.getInstance().getStep(name).value);
  }
  ...
  [BurgerSteps.TOP_BUNS_WITHOUT_SEEDS](): void {
    ...
    console.log("Top bun without seed in builded")
  }
  [BurgerSteps.MEAT](): void {
